	...
	<table>
		<form action="cadastrarConvidado" method="post">
			...
			<tr>
				...
				%>
				<td><input type="text" name="idade" maxlength="3" size=1
					disable value=<%convidado.CalcularIdade();%> /></td>
			</tr>
			<tr>
				<td>CPF:</td>
			...
			<td><input type="radio" name="contBanheiro" value="0" checked>0
				...
				type="text" name="pontosBanheiro" size="4" />
			</tr>
			...
			<td><input type="text" name="pontos" size="1" />
			</tr>
			<td>Criterio Brasil</td>
			<td><input type="text" name="nivel" size="1"
				value=${convidado.nivel }/></td>
			</tr>
	</table>
	<br />
