...
public class Convidado {
	...
	public Convidado(String nome, String rg, String estado, Calendar dataNascimento, int idade, String cpf, String endereco,
			...
			String tempoCidade, String estadoCivil, char temFilhos, int qtdeFilhos, int idadeFilhos1, int idadeFilhos2, int idadeFilhos3, int idadeFilhos4, char trabalhaFora, String profissao,
	...
	public int pontosBanheiro(int contBanheiros) {
	...
	public int pontosMicrocomputador(int contMicrocomputador, int[] microcomputador) {
		return microcomputador[contMicrocomputador];
	...
	public int pontosLavaRoupas(int contLavaRoupas, int[] lavaRoupas) {
